...
public class Fragment_2 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView = inflater.inflate(R.layout.tuto2_fragment, container, false);
		
		showDialog1(R.string.tuto3_title,
				getString(R.string.tuto3_1));
